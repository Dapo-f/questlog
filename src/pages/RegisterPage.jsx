...
function RegisterPage() {
  ...
  function handleSubmit(e) {
    ...
    const { username, email, password, password_confirmation, date_of_birth } =
      formData;
    const userData = {
      username,
      email,
  ...
  return (
    <main className="min-h-screen bg-bg text-text font-outfit">
      <div className="grid md:grid-cols-2 min-h-screen">
        ...
        <div className="hidden md:flex items-center justify-center overflow-hidden bg-bg sticky top-0 h-screen">
        ...
        <div className="flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="mb-4 flex md:hidden flex-col items-center text-center">
